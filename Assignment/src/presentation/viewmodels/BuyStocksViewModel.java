...
public class BuyStocksViewModel
{
  ...
  private final StringProperty statusMessage =
      new SimpleStringProperty("Fill in the form to prepare your order.");
  ...
  public void buy()
  {
    ...
    {
      statusMessage.set("Buy order prepared for " + summarySymbol.get() + ".");
    }
  }
